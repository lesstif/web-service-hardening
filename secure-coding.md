...
얼마전 모 서점에서 주문 번호만 입력하면 다른 이의 배송 정보와 결재 정보를 그대로 볼 수 있는 취약점이 있었습니다. <a name="footnote1">1</a>
...
<sup>[1](#footnote1)</sup> http://www.insight.co.kr/newsRead.php?ArtNo=56987